...
export const EMAIL_REG = /^([a-zA-Z0-9_-]+\.)*[a-zA-Z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/
...
export const APP_ERROR = `Извините за неудобства! 
Сейчас мы работаем над устранением небольшой технической неполадки. 
...
export const SECOND_NAME_REQ = [
  'Отчество должно содержать русские или латинские буквы.',
]
...
export const FEATURES_OPTIONS = [
  ...
  {
    value: 'furnitureForInfants',
    label: <FurnitureForInfantsIcon />,
